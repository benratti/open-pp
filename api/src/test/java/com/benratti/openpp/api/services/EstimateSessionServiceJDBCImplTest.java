...
@ContextConfiguration(classes = EstimateSessionServiceJDBCImplTestConfiguration.class)
public class EstimateSessionServiceJDBCImplTest {

    @Autowired
    EstimateSessionServiceJDBCImpl service;
